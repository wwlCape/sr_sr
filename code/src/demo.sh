...
# CUDA_VISIBLE_DEVICES=7 python main.py --data_test Demo --scale 4 --pre_train download --test_only --save_results
...
# Test your own video
# CUDA_VISIBLE_DEVICES=7 python main.py --data_test video --dir_demo '/data2/yanmengkai/EDSR-PyTorch/test/WeChat_20190501213525.mp4'
# CUDA_VISIBLE_DEVICES=7 python main.py --scale 4 --pre_train download --test_only --save_results --data_test video --dir_demo '/data2/yanmengkai/EDSR-PyTorch/test/WeChat_20190501213525.mp4'

# Test your own images
CUDA_VISIBLE_DEVICES=3 python main.py --data_test Demo --scale 4 --pre_train download --test_only --save_results

# EDSR in the paper (x4) - from EDSR (x2)
# CUDA_VISIBLE_DEVICES=7 python main.py --model EDSR --scale 4 --save edsr_x4 --n_resblocks 32 --n_feats 256 --res_scale 0.1 --reset

CUDA_VISIBLE_DEVICES=3 python main.py --data_train VSRData --data_test VSRData --scale 4 --pre_train download --batch_size 4 --n_GPUs 1 --resume -1  --save_model --model vedsr


CUDA_VISIBLE_DEVICES=3 python main.py --data_train VSRData --data_test VSRData --scale 4 --n_resblocks 32 --n_feats 256 --pre_train download --batch_size 4 --n_GPUs 1 --pre_train download --save_model --model edsr

#submission
CUDA_VISIBLE_DEVICES=3 python main.py --test_only --data_test VSRDemo --scale 4 --resume -1  --save_results --model vedsr